...
public class Servlets {
    ...
    /**
     * 根据浏览器if-Modified-Since Header 计算文件是否已经被修改
     * 如果无修改，checkIfModify返回false，设置304 没有修改状态
     *
     * @param response     响应信息
     * @param request      请求参数
     ...
     * @return
     */
    public static boolean checkIfModifiedSince(HttpServletResponse response, HttpServletRequest request, long lastModified) {
        //从请求信息中获取是否修改文件
